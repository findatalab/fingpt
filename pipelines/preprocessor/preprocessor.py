...
from pipelines.preprocessor.structured_docs_preprocessor import (
    StructuredDocsPreprocessor,
)
...
EMBEDDER_NAME = "deepvk/USER-base"
...
preprocessors_mapping = {
    SourceType.FAQ: FaqPreprocessor(
        embedder_name=EMBEDDER_NAME, document_store=DOCUMENT_STORE
    ),
    SourceType.DOCS: DocsPreprocessor(
        embedder_name=EMBEDDER_NAME, document_store=DOCUMENT_STORE
    ),
    SourceType.STRUCTURED: StructuredDocsPreprocessor(
        embedder_name=EMBEDDER_NAME, document_store=DOCUMENT_STORE
    ),
}
